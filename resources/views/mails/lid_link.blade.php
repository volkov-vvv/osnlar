...
@if($data['link'] != '')
    ...
    <p>Обязательно проверяйте папку СПАМ!!! </p>
@endif
<p>Появились вопросы? <br>
    Наш номер телефона +7 499 677 54 55</p>
<p>Специально для Вашего удобства мы создали <a href="https://t.me/osnovanie_study">телеграм</a> и <a href="https://max.ru/id7751117260_biz">Max</a> каналы, в котором будет вся необходимая и полная информация о программах обучения. А также много полезных материалов для Вас.</p>
